...
function obfuscate(source,VarName,WaterMark)
    ...
    if typeof(WaterMark) == "string" and WaterMark ~= nil then
        WM = "    "..tostring(WaterMark).." | Secure by " .. player
    else
        WM = "    ".."WaterMark".." | Secure by "  .. player
    end
    ...
    game.StarterGui:SetCore("SendNotification", {Text="Obfuscated Successfully (Time taken: " ..tostring(tick() - ticks) .. ")", Title="RiaObfuscator", Duration=5})
